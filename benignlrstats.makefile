...
BENIGNLIST = BCM0074000 BCM0075008 BCM0077000 BCM0081014 BCM0084000 BCM0085001 BCM0086005 BCM0093003 BCM0095002 BCM0109000 BCM0118011 BCM0119011 BCM0120020 BCM0123002 BCM0124003 BCM0128001 BCM0131003 BCM0133001 BCM0137010 BCM0138004 BCM0140013 BCM0144009 BCM0149011 BCM0156019 BCM0159005 BCM0162002 BCM0163000 BCM0167004 BCM0169022

epmstatbenign: $(addprefix epmstats/,$(addsuffix /lstat.csv,$(BENIGNLIST)))
fixedtrain: $(addprefix bcmlirads/,$(addsuffix fixed.train.nii.gz,$(BENIGNLIST)))
qaliradsbenign: $(addprefix bcmdata/,$(addsuffix /qalirads,$(BENIGNLIST)))  
qaepm: $(addprefix bcmdata/,$(addsuffix /qaepm,$(BENIGNLIST)))  
epmbenign: $(addprefix bcmdata/,$(addsuffix /EPM.nii,$(BENIGNLIST)))  

epmauto: $(addprefix bcmdata/,$(addsuffix /autoepm/EPM.nii,$(LIRADSLIST)))  
epmstatauto: $(addprefix autostats/,$(addsuffix /lstat.csv,$(LIRADSLIST)))

#make -k -i -f lrstatistics.makefile qaliradsbenign > qa.txt 2>&1
bcmdata/%/qalirads: 
	echo $*
	c3d bcmdata/$*/fixed.raw.nii.gz  bcmlirads/$*fixed.train.nii.gz -lstat 
#bcmdata/%/qalirads: 
...
bcmdata/%/EPM.nii: bcmdata/%/Pre.longregcc.nii.gz  bcmdata/%/Art.longregcc.nii.gz  bcmdata/%/Ven.longregcc.nii.gz bcmdata/%/Del.longregcc.nii.gz  bcmdata/%/Pst.longregcc.nii.gz
	/rsrch1/ip/dtfuentes/github/cmd_line_epm/run_epm.sh /data/apps/MATLAB/R2022b/  $(@D)/ $(PWD)/bcmdata/$*/Pre.longregcc.nii.gz $(PWD)/bcmdata/$*/Art.longregcc.nii.gz $(PWD)/bcmdata/$*/Ven.longregcc.nii.gz  $(PWD)/bcmdata/$*/Del.longregcc.nii.gz  $(PWD)/bcmdata/$*/Pst.longregcc.nii.gz  $(PWD)/bcmlirads/$*fixed.train.nii.gz  6
bcmdata/%/autoepm/EPM.nii: bcmdata/%/Pre.longregcc.nii.gz  bcmdata/%/Art.longregcc.nii.gz  bcmdata/%/Ven.longregcc.nii.gz bcmdata/%/Del.longregcc.nii.gz  bcmdata/%/Pst.longregcc.nii.gz
	mkdir -p $(@D)
	/rsrch1/ip/dtfuentes/github/cmd_line_epm/run_epm.sh /data/apps/MATLAB/R2022b/  $(@D)/ $(PWD)/bcmdata/$*/Pre.longregcc.nii.gz $(PWD)/bcmdata/$*/Art.longregcc.nii.gz $(PWD)/bcmdata/$*/Ven.longregcc.nii.gz  $(PWD)/bcmdata/$*/Del.longregcc.nii.gz  $(PWD)/bcmdata/$*/Pst.longregcc.nii.gz  $(PWD)/bcmdata/$*/fixed.liver.nii.gz  1
...
bcmdata/%/qaepm: 
	c3d bcmdata/$*/autoepm/EPM.nii  epmstats/$*/reg.train.nii.gz  -lstat
	c3d bcmdata/$*/EPM.nii          epmstats/$*/reg.train.nii.gz  -lstat
...
epmstats/%/lstat.csv: bcmlirads/%fixed.train.nii.gz
	...
	c3d bcmdata/$*/Art.longregcc.nii.gz $<  -lstat > $(@D)/art.txt &&  sed "s/^\s\+/$*,fixed.train.nii.gz,art,/g;s/\s\+/,/g;s/LabelID/InstanceUID,SegmentationID,FeatureID,LabelID/g;s/Vol(mm^3)/Vol.mm.3/g;s/Extent(Vox)/ExtentX,ExtentY,ExtentZ/g" $(@D)/art.txt > $(@D)/art.csv 
	c3d bcmdata/$*/Ven.longregcc.nii.gz $<  -lstat > $(@D)/ven.txt &&  sed "s/^\s\+/$*,fixed.train.nii.gz,ven,/g;s/\s\+/,/g;s/LabelID/InstanceUID,SegmentationID,FeatureID,LabelID/g;s/Vol(mm^3)/Vol.mm.3/g;s/Extent(Vox)/ExtentX,ExtentY,ExtentZ/g" $(@D)/ven.txt > $(@D)/ven.csv 
	if [  -f $(@D)/epm.csv  ]  ; then cat $(@D)/art.csv $(@D)/ven.csv $(@D)/epm.csv  > $@ ; fi 

## epm statistics
autostats/%/lstat.csv: bcmlirads/%fixed.train.nii.gz
	mkdir -p $(@D)
	c3d bcmdata/$*/autoepm/EPM.nii      $<  -lstat > $(@D)/epm.txt &&  sed "s/^\s\+/$*,fixed.train.nii.gz,epm,/g;s/\s\+/,/g;s/LabelID/InstanceUID,SegmentationID,FeatureID,LabelID/g;s/Vol(mm^3)/Vol.mm.3/g;s/Extent(Vox)/ExtentX,ExtentY,ExtentZ/g" $(@D)/epm.txt > $(@D)/epm.csv 
	c3d bcmdata/$*/Art.longregcc.nii.gz $<  -lstat > $(@D)/art.txt &&  sed "s/^\s\+/$*,fixed.train.nii.gz,art,/g;s/\s\+/,/g;s/LabelID/InstanceUID,SegmentationID,FeatureID,LabelID/g;s/Vol(mm^3)/Vol.mm.3/g;s/Extent(Vox)/ExtentX,ExtentY,ExtentZ/g" $(@D)/art.txt > $(@D)/art.csv 
	c3d bcmdata/$*/Ven.longregcc.nii.gz $<  -lstat > $(@D)/ven.txt &&  sed "s/^\s\+/$*,fixed.train.nii.gz,ven,/g;s/\s\+/,/g;s/LabelID/InstanceUID,SegmentationID,FeatureID,LabelID/g;s/Vol(mm^3)/Vol.mm.3/g;s/Extent(Vox)/ExtentX,ExtentY,ExtentZ/g" $(@D)/ven.txt > $(@D)/ven.csv 
	if [  -f $(@D)/epm.csv  ]  ; then cat $(@D)/art.csv $(@D)/ven.csv $(@D)/epm.csv  > $@ ; fi 
