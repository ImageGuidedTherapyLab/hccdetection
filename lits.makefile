...
train:
	/opt/apps/miniforge/mist/bin/mist_train --data /rsrch3/ip/dtfuentes/github/hccdetection/litstumor.json --numpy /rsrch3/ip/dtfuentes/github/hccdetection/litstrainnumpy --results /rsrch3/ip/dtfuentes/github/hccdetection/litstrainresults --gpus 0 --amp --pocket 
