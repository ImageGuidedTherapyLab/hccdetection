...
csv.data <- read.csv("bcmlirads/wideanonAll.csv", header = TRUE,na.strings="")
...
Fixedmask=file.exists(paste0("bcmdata/",csv.data$UID,"/fixed.mask.nii.gz")),
...
Fixedraw=file.exists(paste0("bcmdata/",csv.data$UID,"/fixed.raw.nii.gz")),
...
# Rscript updatetrainbenign.R 2023
# source("updatetrainbenign.R")
