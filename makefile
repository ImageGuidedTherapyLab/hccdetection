...
%/amiralabel: 
	vglrun /opt/apps/Amira/2020.2/bin/start -tclcmd "load $(@D)/Pre.raw.nii.gz; load $(@D)/Ven.raw.nii.gz; load $(@D)/Art.raw.nii.gz; load $(@D)/Truth.raw.nii.gz; create HxCastField ConvertImage; ConvertImage data connect Truth.raw.nii.gz; ConvertImage outputType setIndex 0 7; ConvertImage create result setLabel; Truth.raw.nii.to-labelfield-8_bits ImageData connect Art.raw.nii.gz; "
%/viewraw: 
