...
bcmdata/%.liver.nii.gz:
	...
	c3d -verbose $(subst liver,raw,$@) /rsrch1/ip/atwam/MR_liver/segmentations/$(subst /,_,$*).nii.gz -copy-transform -type char -o $@
...
bcmdata/%.maurer.nii.gz:
	/opt/apps/ANTS/build/ANTS-build/Examples/ImageMath   3 $@  MaurerDistance $(subst maurer,liver,$@)   
